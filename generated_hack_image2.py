...
# Class 364, three-toed_sloth
# 763, revolver
# 759 relfex camera
# 793, shower_cap
# 294, brown_bear
object_type_to_fake = 294

# Load the image to hack
img = image.load_img("sloth.jpg", target_size=(299, 299))
...
while cost < 0.95:
 ...
 #   print("Model's predicted likelihood that the image is a toaster: {:.8}%".format(cost * 100))
    print("Model's predicted likelihood that the image is a brown_bear: {:.8}%".format(cost * 100))
 #  print("Model's predicted likelihood that the image is a three-toed_sloth: {:.8}%".format(cost * 100))
    print("cnt = ",cnt)
